...
{
    public class MenShirtsController : Controller
    {
        ...
        public ActionResult Index(int? page, int? orderby)
        {
            var typeCategory = menShopEntities.TypeCategories
                                               .FirstOrDefault(c => c.TypeCategoryName.Contains("Áo nam"));
            if (typeCategory == null)
            {
                return HttpNotFound("Không tìm thấy TypeCategory chứa 'Áo nam'");
            }
        ...
        public ActionResult ShowMenShirtsByIDCategory(int id, int? page, int? orderby)
        {
