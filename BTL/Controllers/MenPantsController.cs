...
{
    public class MenPantsController : Controller
    {
        ...
        public ActionResult index(int? page, int? orderby)
        {
            var typeCategory = menShopEntities.TypeCategories
                                               .FirstOrDefault(c => c.TypeCategoryName.Contains("Quần nam"));
            if (typeCategory == null)
            {
                return HttpNotFound("Không tìm thấy TypeCategory chứa 'Quần nam'");
            }
        ...
        public ActionResult ShowMenPantsByIDCategory(int id, int? page, int? orderby)
        {
