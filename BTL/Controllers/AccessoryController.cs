    ...
    public class AccessoryController : Controller
    {
        ...
        public ActionResult Index(int? page, int? orderby)
        {
            var typeCategory = menShopEntities.TypeCategories
                                               .FirstOrDefault(c => c.TypeCategoryName.Contains("Phụ kiện"));
            if (typeCategory == null)
            {
                return HttpNotFound("Không tìm thấy TypeCategory chứa 'Phụ kiện'");
            }
        ...
        public ActionResult ShowAccessoriesByIDCategory(int id, int? page, int? orderby)
        {
